...
const SelectPage = () => {
  ...
  const onSearch = (rawValues: Record<string, any>) => {
    ...
    setFilteredLeftLenses(hasLeftEyeValues ? filterLenses('Left') : [])
    setFilteredRightLenses(hasRightEyeValues ? filterLenses('Right') : [])
      ...
      <div className="select-page-form">
        ...
        <Form layout="vertical" form={form}>
          ...
          <Row gutter={16}>
            ...
            <Col span={6}>
              <Form.Item label={labelWithHelp('PD', 'Межзрачковое расстояние')}>
